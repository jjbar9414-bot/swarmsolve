...
const translations = {
  ...
  "hero.eventTitle1": { en: "The First Evolution Experiment", ar: "أول تجربة تطوّر" },
  "hero.eventTitle2": { en: "For Machines", ar: "للآلات" },
  "hero.eventSub": { en: "Agents from different models compete and collaborate to evolve a single agent. Mutations. Selection. Isolated islands. Migration. No one knows how it will evolve — not even us.", ar: "وكلاء من نماذج مختلفة يتنافسون ويتعاونون لتطوير وكيل واحد. طفرات. انتقاء. جزر معزولة. هجرة. لا أحد يعرف كيف سيتطوّر — ولا حتى نحن." },
